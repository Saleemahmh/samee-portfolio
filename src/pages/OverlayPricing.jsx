...
import { Overlaydata } from "../data/Pricingdata";
            ...
            {Overlaydata.map((item) => {
              return (
                <motion.div
                  ...
                  className="flex flex-col flex-1 min-w-[250px] items-center w-72 h-[40rem] backdrop-blur-md bg-[linear-gradient(135deg,rgba(144,224,239,0.4),rgba(0,180,216,0.4))] shadow-md border-beige/20 rounded-md border-2 p-8"
                  key={item.id}
                >
                  <img
                    src={item.img}
          ...
          >
            ...
            >
              <div className="font-playball text-3xl  text-blue">
                ...
                <p className="p-2">
                  2. Provide all necessary details for your overlay, title overlay or menu overlays
                  including any art you want to be added, descriptions, and any specific elements
                  you want included.
                </p>
                <p className="p-2">
                  3. If you have a deadline, please inform me in advance. Once
                  payment is completed, I will keep you updated throughout the
                  process. Your approval is required at each stage for the work
                  to continue.
                </p>
                <p className="p-2">
                  4. The estimated completion time for an overlay is between 1 to 2 days
                 from the time I begin your commission.
                </p>
                <p className="p-2">
                  5. Crediting me at the end of your story is mandatory, as it
                  helps me receive proper recognition for my work.
                </p>
                <p className="p-2">
                  6. I accept payments only through PayPal for commissions.
                </p>
                <p className="p-2">
                  7. Please note that PayPal charges a fee to the recipient.
                  Make sure your payment covers all associated fees and taxes.
                </p>
                <p className="p-2">
                  8. I will not accept payments that require me to pay any fees
                  from my side.
                </p>
                <p className="p-2">
                  9. Full payment is required upfront before I begin the work.
                </p>
                <p className="p-2">
                  10. Kindly share your deadline. Rush orders may incur
                  additional charges.
                </p>
                <p className="p-2">
